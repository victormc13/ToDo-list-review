...
**[ToDo-list-review]** is a project where we are playing the role of code reviewers in pair-programming for the ToDo-list project built with JavaScript and Webpack, using a minimalistic design.
...
- [ToDo-list-review](https://victormc13.github.io/ToDo-list-review/)
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/ToDo-list-review.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/ToDo-list-review/issues).
